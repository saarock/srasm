...
export const Sidebar: React.FC<SidebarProps> = ({
    ...
    <div className="flex flex-col h-full gap-4 p-4 bg-[#181818] rounded-2xl shadow-2xl shadow-[#00000080] w-85">
        {/* Search Input */}
        <div className="sticky top-0 z-10 bg-[#181818] pb-4">
            <input
        ...
        {/* Tree Container */}
        <div className="flex-1 overflow-auto border border-[#2A2A2A] rounded-2xl p-4 shadow-inner shadow-[#00000050]">
            <h3 className="text-lg font-bold text-[#E0E0E0] mb-3 border-b border-[#2A2A2A] pb-2 sticky top-0 bg-[#181818] z-5">
                Hierarchy View
            </h3>
            <Tree
                treeData={treeData}
                ...
                onSelect={onSelect}
                showIcon={false}
                virtual={true} // Enable virtual scrolling for large data
                showLine
                height={400} // optional fixed height for virtual scrolling
