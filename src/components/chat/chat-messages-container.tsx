...
export function ChatMessagesContainer({ messages, currentAiText, loading, textSize }: ChatMessagesContainerProps) {
      ...
      {currentAiText && (
        <div className="flex justify-start">
          <div className="max-w-[85%] rounded-3xl rounded-tl-lg px-6 py-4 bg-[#1A1A1A] text-[#E0E0E0] border border-[#2A2A2A]">
            <div className={textSize === "compact" ? "text-sm" : textSize === "large" ? "text-lg" : "text-base"}>
